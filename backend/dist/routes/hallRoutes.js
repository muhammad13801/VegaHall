...
import { charge, confirmPayment, } from "../controllers/hallOwnerControllers/hallPaymentController.js";
import { getOwnerBookings, proposeReschedule, respondReschedule, customerCancelBooking, customerCancelResponse, ownerCancelBooking, } from "../controllers/hallOwnerControllers/manageBookingsController.js";
import { getHall, updateHall, } from "../controllers/hallOwnerControllers/manageHallController.js";
import { ownerHalls } from "../controllers/hallOwnerControllers/ownerHallsController.js";
import { requestMeal, requestService, } from "../controllers/hallOwnerControllers/serviceRequestsController.js";
const router = Router();
...
router.patch("/bookings/:id/propose-reschedule", sessionAuthenticate, proposeReschedule);
...
router.patch("/bookings/:id/customer-cancel", sessionAuthenticate, customerCancelBooking);
// Owner responds to customer cancellation → decides refund or not
router.patch("/bookings/:id/customer-cancel-response", sessionAuthenticate, customerCancelResponse);
// Owner cancels the booking → status: owner_cancelled, refund is automatic
router.patch("/bookings/:id/owner-cancel", sessionAuthenticate, ownerCancelBooking);
// Get services
