...
import { emailExists, generateCode, } from "../../services/authService.js";
...
export const checkEmail = async (req, res) => {
    ...
    `;
      ...
      WHERE id = ${userId}
    `;
        await sendVerificationCode(email, userData.first_name, userData.last_name, code);
...
export const updateEmail = async (req, res) => {
    ...
    `;
      ...
      `;
            return res
                .status(400)
                .send(`❌ الرمز غير صحيح، المحاولات المتبقية: ${userData.attempts_left - 1}`);
        }
        await sql `
      UPDATE users
      SET email = ${email},
